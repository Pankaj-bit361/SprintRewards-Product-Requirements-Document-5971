...
const navItems=[ {path: '/',label: 'Dashboard',icon: FiTrendingUp},{path: '/tasks',label: 'Tasks',icon: FiList},{path: '/leaderboard',label: 'Leaderboard',icon: FiUsers},{path: '/transactions',label: 'Transactions',icon: FiTrendingUp},...(isFounder ? [{path: '/admin',label: 'Admin Panel',icon: FiSettings}] : []),];
return (

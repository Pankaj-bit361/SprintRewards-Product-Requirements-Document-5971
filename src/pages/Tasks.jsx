...
const {FiPlus,FiEdit3,FiTrash2,FiClock,FiCheckCircle,FiAlertCircle,FiPlay}=FiIcons;
const Tasks=()=> {
...
<button onClick={()=> openEditModal(task)} className="p-2 text-gray-400 hover:text-white transition-colors">
<SafeIcon icon={FiEdit3} className="w-4 h-4" />
</button>
<button onClick={()=> handleDeleteTask(task._id)} className="p-2 text-gray-400 hover:text-white transition-colors">
...
<button onClick={()=> setShowCreateModal(true)} className="inline-flex items-center px-6 py-3 bg-white text-black rounded-lg font-medium hover:bg-gray-200 transition-all">
<SafeIcon icon={FiPlus} className="w-5 h-5 mr-2" />
Create Task
</button>
</div>
